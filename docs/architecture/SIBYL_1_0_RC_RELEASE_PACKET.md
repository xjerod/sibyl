...
- Status: candidate prepared; same-SHA CI and Nightly Regression pending
- Version: `1.0.0-rc.1`
- Branch: final release candidate branch at cut time
...
| Benchmark ledger is claim-safe          | `moon run bench-gate`; external LongMemEval receipt; Nightly Regression compare artifacts                    | Local pass; nightly pending |
...
1. Push the final release candidate branch after explicit go-ahead.
